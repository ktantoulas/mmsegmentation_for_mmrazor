...
@torch.fx.wrap
def _postprocess_result(decode_head, seg_logits: Tensor,
    ...
    for i in range(batch_size):
        ...
        if C > 1:
            ...
            i_seg_pred = (i_seg_logits >
                          decode_head.threshold).to(i_seg_logits) #decode_head_threshold
...
class BaseSegmentor(BaseModel, metaclass=ABCMeta):
    ...
    def postprocess_result(self, decode_head,
                           seg_logits: Tensor,
                           data_samples: OptSampleList = None) -> SampleList:
        ...
        # decode_head_threshold=self.decode_head.threshold,
